...
const createOrders = asyncWrapper(async (req: Request, res: Response): Promise<void | Response> => {
...
const getOrderById = asyncWrapper(async (req: Request, res: Response): Promise<void | Response> => {
...
const updateOrder = asyncWrapper(async (req: Request, res: Response): Promise<void | Response> => {
...
const deleteOrder = asyncWrapper(async (req: Request, res: Response): Promise<void | Response> => {
  const oid = parseInt(req.params.id);
